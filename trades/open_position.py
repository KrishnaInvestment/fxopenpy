...
class Position(RequstAPI):
    ...
    def verify_boolean(bool_value):
        ...
        if not is_bool:
            raise ValueError("Verification failed. Expected a bool, but received a non-bool value")
    ...
    def __make_payload(
        self, type, stop_loss=None, target=None, price=None, stop_price=None, **kwargs
    ):
